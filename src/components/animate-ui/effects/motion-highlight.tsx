...
const MotionHighlightContext = React.createContext<
    // biome-ignore lint/suspicious/noExplicitAny: animate-ui code
...
function MotionHighlight<T extends string>({
    ...
    const boundsOffset_ = (props as ParentModeMotionHighlightProps)
        ?.boundsOffset;
    const safeSetBounds = React.useCallback(
        (bounds: DOMRect) => {
            ...
            const boundsOffset = boundsOffset_ ?? {
                top: 0,
                left: 0,
                width: 0,
                height: 0,
    ...
    const containerClassName = (props as ParentModeMotionHighlightProps)
        ?.containerClassName;
